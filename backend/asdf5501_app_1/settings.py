"""
Django settings for asdf5501_app_1 project.
...
ROOT_URLCONF = 'asdf5501_app_1.urls'
...
WSGI_APPLICATION = 'asdf5501_app_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "asdf5501 app Support <support@asdf5501-app-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdf5501_app_1 API",
    "DESCRIPTION": "API documentation for asdf5501_app_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "asdf5501_app_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "asdf5501_app_1.storage_backends.AzureStaticStorage"
